...
class Filter:
    class Valves(BaseModel):
        ...
        RESTRICTED_CATEGORIES: str = Field(
            default="1) Share highly confidential information with unauthorized individuals or external parties without proper approval. Examples of Highly Confidential Information: UAE Financial Status/Records, financial transactions of UAE government entities, CBUAE IT infrastructure details.",
